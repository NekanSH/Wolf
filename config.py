...
STALE_CANDLES = 2               # было 4 — мёртвые позиции режем быстрее
STALE_PEAK_MIN = 0.07           # было 0.10 — нужно хоть 0.10% движение
...
CONFIRM_VOL_MULT = 0.05         # было 0.3 — слишком высоко, блокировало всё
CONFIRM_BASE_VOL = 10.0         # было 100 — снижаем baseline
CONFIRM_TIMEOUT_SEC = 60        # было 30 — даём больше времени
...
BTC_MACRO_FILTER = False        # ОТКЛЮЧЁН: слишком агрессивно блокирует
